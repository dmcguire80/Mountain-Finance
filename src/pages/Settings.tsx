            ...
            <div className="card p-6 mb-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 rounded-full transition-colors ${darkMode ? 'bg-[var(--color-primary)]' : 'bg-[var(--border-color)]'
                            }`}
                    >
                        <span
                            className={`inline-block h-5 w-5 rounded-full bg-white shadow transform transition-transform mt-0.5 ${darkMode ? 'translate-x-5' : 'translate-x-0.5'
                                }`}
                        />
                    </button>
                </div>
