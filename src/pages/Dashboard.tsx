        ...
        <div className="animate-fadeIn">
            ...
            <div className="gradient-primary text-white p-8 rounded-xl shadow-lg mb-8 text-center">
                ...
                {summary.totalChangeAmount !== 0 && (
                    <div
                        className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg font-semibold ${summary.totalChangeAmount >= 0 ? 'bg-white/15' : 'bg-white/15'
                            }`}
                    >
                        {summary.totalChangeAmount >= 0 ? (
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer text-sm text-[var(--text-secondary)]">
                        <input
                            ...
                            className="w-4 h-4"
                        />
                        <span>Show individual accounts</span>
                    </label>
                </div>
                <PortfolioChart
                    data={chartData}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {summary.accounts.map((account) => (
                            ...
                            >
                                ...
                                <div
                                    className={`flex items-center gap-1 text-sm font-semibold ${account.changeAmount >= 0 ? 'text-positive' : 'text-negative'
                                        }`}
                                >
